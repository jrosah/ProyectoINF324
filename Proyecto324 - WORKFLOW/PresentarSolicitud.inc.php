    ...
    <div class="container bg-white px-0 pb-5 shadow-lg">
        ...
        <div class="px-5 mt-5 d-flex justify-content-center flex-column align-items-center bg-red">
            <div class="shadow px-5 pb-5">
                ...
                <p>Los créditos ayudan a materializar los sueños de las personas y hacerlos realidad. Acceder a ellos es simple, sólo se deben cumplir ciertos términos y condiciones para hacerlo, pero antes de entrar en ese punto, es importante saber cuándo se requiere un crédito y quiénes lo otorgan.</p>
